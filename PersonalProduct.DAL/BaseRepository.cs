...
using PersonalCompany.PersonalProduct.Utility.Common;
using PersonalCompany.PersonalProduct.Utility.Configuration;
using static Dapper.SqlMapper;

namespace PersonalCompany.PersonalProduct.DAL
{
    /// <summary>
    ...
    public static class BaseRepository
    {
        ...
        internal static string sqlConnectionString = AppSettings.ConnectionString;


        public static async Task<object> ScalarQueryDt(string query,DataTable dt=null ,object param = null, IDbTransaction transaction = null, int? commandTimeout = null)
        {
            var task = Task.Run(() =>
            {
                ...
                using (connection = new SqlConnection(sqlConnectionString))
                {
                    ...
                    var result = connection.ExecuteScalar(query, param, transaction);
                    connection.Close();
                    return result;
                }
            });
        ...
        public static async Task<object> ScalarQuery(string query,object param=null ,IDbTransaction transaction = null, int? commandTimeout = null)
        {
            var task = Task.Run(() =>
            {
                IDbConnection connection = null;
        ...
        public static async Task<IEnumerable<T>> GetListUsingStandardProcedure<T>(string procedureName, Dictionary<string, string> parameters)
        {
            var task = Task.Run(() =>
            {
                IDbConnection connection = null;
        ...
        public static async Task<int> Query(string query,object param=null ,IDbTransaction transaction = null, int? commandTimeout = null)
        {
        ...
        public static async Task<DataTable> GetDataTables(string query, object param, IDbTransaction transaction = null, int? commandTimeout = null)
        {
            ...
            using (connection = new SqlConnection(sqlConnectionString))
            {
                ...
                IDataReader result = connection.ExecuteReader(query, param);
                table.Load(result);
                connection.Close();
            }
            return table;
        ...
        public static async Task<IEnumerable<T>> AdvancedCustomQueryList<T>(string query, object param, IDbTransaction transaction = null, int? commandTimeout = null)
        {
            var currenttype = typeof(T);
        ...
        public static async Task<Dictionary<string, IEnumerable<object>>> AdvancedCustomQueryMultiple(string query, object param, IEnumerable<string> DBSetNames, IDbTransaction transaction = null, int? commandTimeout = null)
        {
            //var currenttype = typeof(GridReader);
            ...
            var task = Task.Run(() =>
            {
                ...
                using (connection = new SqlConnection(sqlConnectionString))
                {
                    ...
                    Dapper.DefaultTypeMap.MatchNamesWithUnderscores = true;
                    var result = connection.QueryMultiple(query, param, transaction);

                    Dictionary<string, IEnumerable<object>> list = new Dictionary<string, IEnumerable<object>>();

                    foreach (string name in DBSetNames)
                    {
                        list.Add(name, result.Read());
                    }
        ...
        public static async Task<T> AdvancedCustomQuery<T>(string query, object param, IDbTransaction transaction = null, int? commandTimeout = null)
        {
            //var currenttype = typeof(T);
