...
namespace PersonalCompany.PersonalProduct.Utility.Common
{
    public static class Common
    {
        ...
        public static string EncodeAsciiToBase64(string toEncode)
        {
        ...
        {
            //DateTime AppDate = DateTime.SpecifyKind(DateTime.ParseExact(DateTime.UtcNow.ToString("yyyy/MM/dd hh:mm:ss"), "yyyy/MM/dd hh:mm:ss", CultureInfo.InvariantCulture), DateTimeKind.Utc);
